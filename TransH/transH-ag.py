...
class TransHagModel(object):
    ...
    def __init__(self, config):
        ...
        with tf.name_scope("embedding"):
            ...
            pos_a_norm = tf.nn.embedding_lookup(self.normal_vector, self.pos_r_a)
            ...
            pos_h_a_e = self.calc(pos_h_a_e, pos_a_norm)
            pos_t_a_e = self.calc(pos_t_a_e, pos_a_norm)
    ...
    with tf.Graph().as_default():
        ...
        with sess.as_default():
            ...
            with tf.variable_scope("model", reuse=None, initializer = initializer):
                trainModel = TransHagModel(config = config)
            ...
            if (config.loadFromData):
                saver.restore(sess, './model/transhagmodel.vec')
            ...
            if not config.testFlag:
                for times in range(config.trainTimes):
                    ...
                    print times
                    print res
                saver.save(sess, './model/transhagmodel.vec')
            else:
